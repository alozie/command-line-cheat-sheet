...
a cheat sheet for common (and some uncommon) command line tasks required when administering web applications, Drupal in particular
...
## from http://the.taoofmac.com/space/HOWTO/Merge%20Folders
...
# taken from http://www.no-ack.org/2010/08/merge-directories-on-unix-like-systems.html
...
Find files in specific files, exclude certain paths, and show first occurrence of sp
ecific string in content
---------------------------------------------------------------------------------
...
---------------------------------------------------------------
# found at: http://stackoverflow.com/questions/542065/svn-remove-file-from-repository-without-deleting-local-copy
